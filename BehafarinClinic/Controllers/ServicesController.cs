...
namespace BehafarinClinic.Controllers
{
    public class ServicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ServiceId,SeviceTitle,Price")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ServiceId,SeviceTitle,Price")] Service service)
        {
            if (ModelState.IsValid)
            {
